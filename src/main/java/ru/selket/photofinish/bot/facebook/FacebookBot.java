package ru.selket.photofinish.bot.facebook;
...
public class FacebookBot extends Bot {
    ...
    public void init() {
        ...
        setGreetingText(new Payload[]{new Payload().setLocale("default").setText("Welcome to PhotoFinish! You can get photos from competitions clicking " +
    ...
    /**
     * This method will be invoked after {@link FacebookBot#setupMeeting(Event)}. You need to
    ...
    /**
     * This method will be invoked after {@link FacebookBot#confirmTiming(Event)}. You can
    ...
    /**
     * This method will be invoked after {@link FacebookBot#askTimeForMeeting(Event)}. You can
     * call {@link Bot#stopConversation(Event)} to end the conversation.
     *
     * @param event
     */
